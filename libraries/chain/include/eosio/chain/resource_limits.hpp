...
namespace eosio { namespace chain { namespace resource_limits {
   ...
   class resource_limits_manager {
      public:
         ...
         void initialize_account_xos( const account_name& account );
         void set_block_parameters_xos(uint16_t free_resource_limit_per_day);

      
         void add_transaction_usage_xos( const account_name& account);
         std::tuple<int64_t,int64_t,int64_t> check_account_limits_xos( const account_name& account,int64_t ram_bytes, int64_t net_weight, int64_t cpu_weight) const;
         void get_account_limits_xos( const account_name& account, int64_t& ram_bytes, int64_t& net_weight, int64_t& cpu_weight) const;
      private:
