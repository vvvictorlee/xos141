   ...
   class controller {
      public:
         ...
         authorization_manager&                get_mutable_authorization_manager();
            ...
            ///xos begin
         const global_property_list_object& get_global_properties_list(uint16_t type)const;
         const global_property_object_ex& get_global_properties_ex()const;
          void add_config_list(uint16_t type,const account_name_list& list);
            void set_config_string_list(string& type,string& action,const string& list);
            ///xos end
